<template>
  <el-container>
    <div  class="main nav5_2">
      <div class="content">
        <div class="header" style="font-size:12px;">
          <div >{{$t('nav5_2.title')}}</div>
          <div class="rightbtn">
            <div class="block">
            ...
            <div class="rightDiv">
              ...
              <el-row  class="rightTable">
                <el-table :data="main.rightDiv.tableData" style="margin-left: 20px;border:1px solid #d8dce5;" :default-sort = "{prop: 'date', order: 'descending'}" width="100%" height="calc()" id="rightTable">
                  ...
                  <el-table-column prop="progress" :label="$t('nav5_2.main.rightDiv.CPU')" sortable>
                  </el-table-column>
                </el-table>
              </el-row>
            </div>
  ...
  export default {
    data () {   /*组件的data对象是data()函数不是data*/
      return {
        ...
        main:{
          ...
          value3:this.$t('nav5_2.main.options3.cell_1'),
          options3: [
            {
              value: this.$t('nav5_2.main.options3.cell_1'),
              label: this.$t('nav5_2.main.options3.cell_1')
            }, {
              value: this.$t('nav5_2.main.options3.cell_2'),
              label: this.$t('nav5_2.main.options3.cell_2')
            }, {
              value: this.$t('nav5_2.main.options3.cell_3'),
              label: this.$t('nav5_2.main.options3.cell_3')
            },{
              value: this.$t('nav5_2.main.options3.cell_4'),
              label: this.$t('nav5_2.main.options3.cell_4')
            }, {
              value: this.$t('nav5_2.main.options3.cell_5'),
              label: this.$t('nav5_2.main.options3.cell_5')
            }, {
              value: this.$t('nav5_2.main.options3.cell_6'),
              label: this.$t('nav5_2.main.options3.cell_6')
            }],
          value4:'Average',
          options4: [
            {
          ...
          leftDiv:{
            title:{
              show:"true",
              text: this.$t('nav5_2.main.options3.cell_1') + ' by '+ this.$t('nav5_1.main.options1.cell_1') + '（2017-12-02~2018-01-01）: '+ this.$t('nav5_2.main.options3.cell_1'),
              left:"center",
              textStyle:{//标题内容的样式
                color:'#3e3e3e',
    ...
    methods: {
      ...
      i18nChart : function () {
        ...
        this.main.options3[0].value = this.$t('nav5_2.main.options3.cell_1');
        this.main.options3[1].value = this.$t('nav5_2.main.options3.cell_2');
        this.main.options3[2].value = this.$t('nav5_2.main.options3.cell_3');
        this.main.options3[3].value = this.$t('nav5_2.main.options3.cell_4');
        this.main.options3[4].value = this.$t('nav5_2.main.options3.cell_5');
        this.main.options3[5].value = this.$t('nav5_2.main.options3.cell_6');
        ...
        this.main.options3[0].label = this.$t('nav5_2.main.options3.cell_1');
        this.main.options3[1].label = this.$t('nav5_2.main.options3.cell_2');
        this.main.options3[2].label = this.$t('nav5_2.main.options3.cell_3');
        this.main.options3[3].label = this.$t('nav5_2.main.options3.cell_4');
        this.main.options3[4].label = this.$t('nav5_2.main.options3.cell_5');
        this.main.options3[5].label = this.$t('nav5_2.main.options3.cell_6');
        ...
        this.main.value3 = this.$t('nav5_2.main.options3.cell_1');
        var mychart1 = this.echarts.init(document.getElementById('myChart1'));
        this.main.leftDiv.title.text = this.$t('nav5_2.main.options3.cell_1') + 'by'+ this.$t('nav5_1.main.options1.cell_1') + '（2017-12-02~2018-01-01）: '+ this.$t('nav5_2.main.options3.cell_1');
