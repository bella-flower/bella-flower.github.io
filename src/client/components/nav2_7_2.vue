<template>
  <el-container class="main nav2_7_2">
    <div class="content">
      <div class="header">
        <div>{{$t('nav2_7_2.title')}}</div>
        <div class="rightbtn">
      ...
      <el-row class="view-item">
        <ul class="view_ul">
          <li class="li-item">
            <el-upload action="https://localhost:8080" class="uploadImg" :on-preview="handlePictureCardPreview">
              <i class="el-icon-plus"></i>
            </el-upload>
          </li>
          <li class="li-item" v-for="(item,index) in officeData" @click="itemSelected(index)" :class="{item_hover: activeIndex ==index}">
            <img v-bind:src="item.src" alt="" class="icons"   >
          </li>
        </ul>
      </el-row>
    </div>
...
<style>
  .view-item .view_ul .el-upload--text{
