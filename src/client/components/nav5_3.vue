<template>
  <el-container>
    <div  class="main nav5_3">
      <div class="content">
        <div class="header" style="font-size:12px;">
          <div >{{$t('nav5_3.title')}}</div>
          <div class="rightbtn">
            <div class="block">
        ...
        <el-row class="view-item" style="padding-top: 5px;">
          <el-row style="margin-bottom: 5px;">
            <div class="right">
              <div class="block">
                <span class="demonstration">{{$t('nav5_3.main.btn_1')}}</span>
              ...
              <div class="block">
                <span class="demonstration">{{$t('nav5_3.main.btn_2')}}</span>
              ...
              <div class="block">
                <span class="demonstration">{{$t('nav5_3.main.btn_3')}}</span>
              ...
              <div class="block">
                <span class="demonstration">{{$t('nav5_3.main.btn_4')}}</span>
              ...
              <div>
                <span class="demonstration">{{$t('nav5_3.main.btn_5')}}</span>
                <el-select v-model="main.value5" :placeholder="$t('nav3_2.select3.placeholder')" size="small" style="width:120px;"  >
                  <el-option  v-for="(item, index) in main.options5" :key="item.value" :label="item.label" :value="item.value">
                  </el-option>
                </el-select>
              </div>
            ...
            <div class="rightDiv">
              ...
              <el-row  class="rightTable">
                <el-table :data="main.rightDiv.tableData" style="margin-left: 20px;border:1px solid #d8dce5;" :default-sort = "{prop: 'date', order: 'descending'}" width="100%" height="calc()" id="rightTable">
                  ...
                  <el-table-column prop="progress" :label="$t('nav5_3.main.rightDiv.CPU')" sortable>
  ...
  export default {
    data () {   /*组件的data对象是data()函数不是data*/
      return {
        ...
        main:{
          ...
          value2:this.$t('nav5_3.main.options2.cell_1'),
          options2: [
            {
              value: this.$t('nav5_3.main.options2.cell_1'),
              label: this.$t('nav5_3.main.options2.cell_1')
            }],
          value3:this.$t('nav5_3.main.options3.cell_1'),
          options3: [
            {
              value: this.$t('nav5_3.main.options3.cell_1'),
              label: this.$t('nav5_3.main.options3.cell_1')
            }, {
              value: 'demo1',
              label: 'demo1'
            }, {
          ...
          value4:this.$t('nav5_3.main.options4.cell_1'),
          options4: [
            {
              value: this.$t('nav5_3.main.options4.cell_1'),
              label: this.$t('nav5_3.main.options4.cell_1')
            }, {
              value: this.$t('nav5_3.main.options4.cell_2'),
              label:this.$t('nav5_3.main.options4.cell_2')
            }, {
              value: this.$t('nav5_3.main.options4.cell_3'),
              label: this.$t('nav5_3.main.options4.cell_3')
            }],
          value5:'Total',
          options5:[
            {
          ...
          leftDiv:{
            title:{
              show:"true",
              text: this.$t('nav5_2.main.options3.cell_1') + ' by ' + '（2017-12-02~2018-01-01）: '+ this.$t('nav5_3.main.options2.cell_1'),
              left:"center",
              textStyle:{//标题内容的样式
                color:'#3e3e3e',
            ...
            series: [
              {
                name:this.$t('nav5_2.main.options3.cell_1'),
                type:'line',
                smooth: true,
    ...
    methods: {
      ...
      i18nChart : function () {
        ...
        this.main.options2[0].value = this.$t('nav5_3.main.options2.cell_1');
        this.main.options3[0].value = this.$t('nav5_3.main.options3.cell_1');
        this.main.options2[0].label = this.$t('nav5_3.main.options2.cell_1');
        this.main.options3[0].label = this.$t('nav5_3.main.options3.cell_1');
        this.main.options4[0].value = this.$t('nav5_3.main.options4.cell_1');
        this.main.options4[1].value = this.$t('nav5_3.main.options4.cell_1');
        this.main.options4[2].value = this.$t('nav5_3.main.options4.cell_1');
        this.main.options4[0].label = this.$t('nav5_3.main.options4.cell_1');
        this.main.options4[1].label = this.$t('nav5_3.main.options4.cell_1');
        this.main.options4[2].label = this.$t('nav5_3.main.options4.cell_1');
        this.main.value2 = this.$t('nav5_3.main.options2.cell_1');
        this.main.value3 = this.$t('nav5_3.main.options3.cell_1');
        this.main.value4 = this.$t('nav5_3.main.options4.cell_1');
        var mychart1 = this.echarts.init(document.getElementById('myChart1'));
        this.main.leftDiv.title.text = this.$t('nav5_3.main.options4.cell_1') + 'by' + '（2017-12-02~2018-01-01）: '+ this.$t('nav5_3.main.options2.cell_1');
